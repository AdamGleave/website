...
I am **not** arguing that **most** people contributing to AI safety should do PhDs. In fact, a PhD is not the best preparation for the **majority** of roles. If you want to become a really strong empirical research contributor, then start working as a research engineer on a great team: you will learn how to execute and implement faster than in a PhD. There are also a variety of key roles in communications, project management, field building and operations where a PhD is of limited use. But we believe a PhD is excellent preparation for **becoming a research lead** with your own distinctive research direction that you can clearly communicate and ultimately supervise junior researchers to work on.
