...
summary: LaTeX is the typesetting system of choice in most STEM fields. Yet even many experienced LaTeX users fall prey to many gotchas, or fail to exploit some powerful aspects of the language. In this document, I collect together *design patterns* to help efficiently produce clear LaTeX documents.
authors:
- AdamGleave
date: "2020-08-06"
lastmod: "2020-08-06"
...
[LaTeX](https://www.latex-project.org/) is the typesetting system of choice in most STEM fields -- indeed, many venues in computer science *only* accept submissions produced by LaTeX.
...
In the spirit of [design patterns](https://en.wikipedia.org/wiki/Software_design_pattern), this document aims to collect together *patterns* in LaTeX that enable efficient and clear writing, and *antipatterns* which interfere with this goal.
Take these patterns as suggestions, not strict rules.
What may be a pattern in one document can be an antipattern in another: for example, defining macros for notation would be beneficial in a PhD thesis, but perhaps overkill for an extended abstract.
...
I am indebted to my advisers throughout the years patiently correcting my own writing, especially [Jan Leike](https://jan.leike.name/) and [Malte Schwarzkopf](http://cs.brown.edu/people/malte/).
I would also like to thank TODO and others for contributing their own suggestions to this list.
...
**Punctuate Your Math**: Mathematics forms an integral part of your text, and should be punctuated accordingly. For example, if your sentence ends with an equation, the equation should end with a period. It can often be helpful to imagine punctuating everything as if it was inline math (`$...$`), even if you are using display math (`$$...$$` or `\begin{equation}...\end{equation}`). [Stackexchange](https://tex.stackexchange.com/questions/7542/for-formal-articles-should-a-displayed-equation-be-followed-by-a-punctuation-to) has a good discussion on this.
